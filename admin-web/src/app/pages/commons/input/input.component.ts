...
import {SearchObject} from '../../../utils/search-object.model';
...
import {
  ...
  NzInputDirective,
  NzInputGroupComponent, NzInputPrefixDirective, NzInputSuffixDirective
...
export class InputComponent implements OnInit, ControlValueAccessor, OnChanges {
  static nextId = 0;
  @HostBinding()
  id: string = `nuclear-input-${InputComponent.nextId++}`;
