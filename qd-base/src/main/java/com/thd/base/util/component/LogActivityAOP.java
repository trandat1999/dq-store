...
public class LogActivityAOP {
    @Around("@annotation(com.thd.base.util.anotation.LogActivity)")
    public Object logUsername(ProceedingJoinPoint call) throws Throwable {
        ...
        for(int i = 0; i < args.length; i++){
            for (Annotation annotation : parameterAnnotations[i]) {
                ...
                params.append(pathVariable.value()).append(ConstUtils.EQUAL).append(ConstUtils.SPACE).append(args[i]);
            }
        }
